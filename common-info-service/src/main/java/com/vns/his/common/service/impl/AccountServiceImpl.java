package com.vns.his.common.service.impl;

import com.vns.his.common.converter.AccountConverter;
import com.vns.his.common.dto.AccountDto;
import com.vns.his.common.entity.Account;
import com.vns.his.common.repository.AccountRepo;
import com.vns.his.common.service.interfaces.AccountService;
...
public class AccountServiceImpl implements AccountService {
	...
	public ResponseEntity<Object> save(AccountDto accountDto) {
		...
		if (accountDto.getUserId() == null) {
			...
			account.setUserId(getNewId());
		} else {
			account = getByIdThrowException(accountDto.getUserId());
	...
	public Integer getNewId() {
		Integer newId = 0;
		Account account = accountRepo.findTopByOrderByUserIdDesc();
		if (account != null) {
			newId = account.getUserId() + 1;
		}
		return newId;
	}
